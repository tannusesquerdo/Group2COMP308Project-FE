...
const CreatePatient = React.lazy(() => import("./views/nurse/CreatePatient"));
const InformationSheet = React.lazy(() =>
  import("./views/nurse/InformationSheet")
);
...
); // Added on 12/04/2023 by TJ
const PreviousClinicalVisitInfo = React.lazy(() =>
  import("./views/nurse/PreviousClinicalVisitInfo")
); // Added on 12/04/2023 by TJ
const MedicalConditionsList = React.lazy(() =>
  import("./views/nurse/MedicalConditionsList")
); // Added on 12/04/2023 by TJ
...
const SymptomsChecklist = React.lazy(() =>
  import("./views/patient/SymptomsChecklist")
); // Added on 12/04/2023 by HK
const CreateVitalAlert = React.lazy(() =>
  import("./views/patient/CreateVitalAlert")
); // Added on 12/04/2023 by HK
...
const routes = [
  ...
  {
    path: "/nurse/medical-conditions-lists",
    name: "Medical Conditions",
    element: MedicalConditionsList,
  }, // Added on 12/04/2023 by TJ
  ...
  { path: "/nurse/add/patient", name: "Add Patient", element: CreatePatient }, // Added on 12/04/2023 by HK
  {
    path: "/nurse/patients/:id",
    name: "Patients Sheet",
    element: InformationSheet,
  },
  {
    path: "/nurse/patients/:id/vital-signs",
  ...
  {
    path: "/patient/symptoms-checklist",
    name: "Symptoms Checklist",
    element: SymptomsChecklist,
  }, // Added on 12/04/2023 by HK
  {
    path: "/patient/create-vital-alert",
    name: "Create Vital Alert",
    element: CreateVitalAlert,
  }, // Added on 12/04/2023 by HK
];
