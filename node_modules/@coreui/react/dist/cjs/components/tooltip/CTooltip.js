...
var CTooltip = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        React.cloneElement(children, tslib_es6.__assign(tslib_es6.__assign(tslib_es6.__assign({ ref: togglerRef }, ((trigger === 'click' || trigger.includes('click')) && {
        ...
        React.createElement(CConditionalPortal.CConditionalPortal, { container: container, portal: true },
            React.createElement(Transition.default, { in: _visible, mountOnEnter: true, nodeRef: tooltipRef, onEnter: onShow, onExit: onHide, timeout: {
                    enter: 0,
