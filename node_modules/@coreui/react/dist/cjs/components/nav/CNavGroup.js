...
var CNavGroup = React.forwardRef(function (_a, ref) {
    var children = _a.children, className = _a.className, compact = _a.compact, idx = _a.idx, toggler = _a.toggler, visible = _a.visible, rest = tslib_es6.__rest(_a, ["children", "className", "compact", "idx", "toggler", "visible"]);
    var _b = React.useState(), height = _b[0], setHeight = _b[1];
    var navItemsRef = React.useRef(null);
    var _c = React.useContext(CSidebarNav.CNavContext), visibleGroup = _c.visibleGroup, setVisibleGroup = _c.setVisibleGroup;
    ...
    return (React.createElement("li", tslib_es6.__assign({ className: index.default('nav-group', { show: _visible }, className) }, rest, { ref: ref }),
        ...
        React.createElement(Transition.default, { in: _visible, nodeRef: navItemsRef, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, timeout: 300 }, function (state) { return (React.createElement("ul", { className: index.default('nav-group-items', {
                compact: compact,
            }), style: tslib_es6.__assign(tslib_es6.__assign({}, style), transitionStyles[state]), ref: navItemsRef }, React.Children.map(children, function (child, index) {
