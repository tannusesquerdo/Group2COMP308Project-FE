...
CBadge.propTypes = {
  ...
  color: colorPropType,
  component: import_prop_types18.default.string,
...
var CButton = (0, import_react21.forwardRef)(function(_a, ref) {
  ...
  return import_react21.default.createElement(CLink, __assign({ component: rest.href ? "a" : component }, !rest.href && { type }, { className: classNames("btn", variant ? "btn-".concat(variant, "-").concat(color) : "btn-".concat(color), (_b = {}, _b["btn-".concat(size)] = size, _b), shape, className) }, rest, { ref }), children);
});
CButton.propTypes = {
...
var CCard = (0, import_react25.forwardRef)(function(_a, ref) {
  ...
  return import_react25.default.createElement("div", __assign({ className: classNames("card", (_b = {}, _b["bg-".concat(color)] = color, _b["text-".concat(textColor)] = textColor, _b), className) }, rest, { ref }), children);
});
CCard.propTypes = {
...
var CDropdownItem = (0, import_react44.forwardRef)(function(_a, ref) {
  ...
  return import_react44.default.createElement(CLink, __assign({ className: classNames("dropdown-item", className), component }, rest, { ref }), children);
});
...
var CListGroupItem = (0, import_react75.forwardRef)(function(_a, ref) {
  ...
  return import_react75.default.createElement(Component, __assign({ className: classNames("list-group-item", (_b = {}, _b["list-group-item-".concat(color)] = color, _b["list-group-item-action"] = component === "a" || component === "button", _b.active = active, _b.disabled = disabled, _b), className) }, rest), children);
});
...
var CNavGroupItems = (0, import_react84.forwardRef)(function(_a, ref) {
  var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
  return import_react84.default.createElement("ul", __assign({ className: classNames("nav-group-items", className) }, rest, { ref }), children);
});
...
var CSidebarNav = (0, import_react85.forwardRef)(function(_a, ref) {
  var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
  var _b = (0, import_react85.useState)(""), visibleGroup = _b[0], setVisibleGroup = _b[1];
  ...
  return import_react85.default.createElement(
    ...
    import_react85.default.createElement(CNavContext.Provider, { value: CNavContextValues }, import_react85.default.Children.map(children, function(child, index) {
      if (import_react85.default.isValidElement(child)) {
...
var CNavGroup = (0, import_react86.forwardRef)(function(_a, ref) {
  ...
  var _b = (0, import_react86.useState)(), height = _b[0], setHeight = _b[1];
  var navItemsRef = (0, import_react86.useRef)(null);
  var _c = (0, import_react86.useContext)(CNavContext), visibleGroup = _c.visibleGroup, setVisibleGroup = _c.setVisibleGroup;
  var _d = (0, import_react86.useState)(Boolean(visible || idx && visibleGroup && isInVisibleGroup(visibleGroup, idx))), _visible = _d[0], setVisible = _d[1];
  ...
  return import_react86.default.createElement(
    ...
    import_react86.default.createElement(Transition$1, { in: _visible, nodeRef: navItemsRef, onEntering, onEntered, onExit, onExiting, onExited, timeout: 300 }, function(state) {
      return import_react86.default.createElement("ul", { className: classNames("nav-group-items", {
        compact
      }), style: __assign(__assign({}, style), transitionStyles[state]), ref: navItemsRef }, import_react86.default.Children.map(children, function(child, index) {
        if (import_react86.default.isValidElement(child)) {
          return import_react86.default.cloneElement(child, {
            key: index,
...
var CNavItem = (0, import_react88.forwardRef)(function(_a, ref) {
  var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
  return import_react88.default.createElement("li", { className: classNames("nav-item", className), ref }, rest.href || rest.to ? import_react88.default.createElement(CNavLink, __assign({ className }, rest), children) : children);
});
CNavItem.propTypes = {
...
var CNavTitle = (0, import_react89.forwardRef)(function(_a, ref) {
  var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
  return import_react89.default.createElement("li", __assign({ className: classNames("nav-title", className) }, rest, { ref }), children);
});
CNavTitle.propTypes = {
...
var CNavbarNav = (0, import_react92.forwardRef)(function(_a, ref) {
  var children = _a.children, _b = _a.component, Component = _b === void 0 ? "ul" : _b, className = _a.className, rest = __rest(_a, ["children", "component", "className"]);
  return import_react92.default.createElement(Component, __assign({ className: classNames("navbar-nav", className), role: "navigation" }, rest, { ref }), children);
});
...
var CPaginationItem = (0, import_react100.forwardRef)(function(_a, ref) {
  ...
  }, className) }, rest.active && { "aria-current": "page" }), Component === "a" ? import_react100.default.createElement(CLink, __assign({ className: "page-link", component: Component }, rest, { ref }), children) : import_react100.default.createElement(Component, { className: "page-link", ref }, children));
});
...
var CPopover = (0, import_react105.forwardRef)(function(_a, ref) {
  ...
  return import_react105.default.createElement(
    ...
    null,
    import_react105.default.cloneElement(children, __assign(__assign(__assign({ ref: togglerRef }, (trigger === "click" || trigger.includes("click")) && {
      onClick: function() {
    ...
    import_react105.default.createElement(
      ...
      import_react105.default.createElement(Transition$1, { in: _visible, mountOnEnter: true, nodeRef: popoverRef, onEnter: onShow, onExit: onHide, timeout: {
        enter: 0,
...
var CSidebarBrand = (0, import_react107.forwardRef)(function(_a, ref) {
  var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
  return import_react107.default.createElement("div", __assign({ className: classNames("sidebar-brand", className), ref }, rest), children);
});
...
CSpinner.propTypes = {
  ...
  color: colorPropType,
  component: import_prop_types110.default.string,
...
CToastClose.propTypes = __assign(__assign({}, CCloseButton.propTypes), { component: import_prop_types124.default.elementType });
...
var CTooltip = (0, import_react128.forwardRef)(function(_a, ref) {
  ...
  return import_react128.default.createElement(
    ...
    null,
    import_react128.default.cloneElement(children, __assign(__assign(__assign({ ref: togglerRef }, (trigger === "click" || trigger.includes("click")) && {
      onClick: function() {
        return toggleVisible(!_visible);
      }
    }), (trigger === "focus" || trigger.includes("focus")) && {
    ...
    import_react128.default.createElement(
      CConditionalPortal,
      { container, portal: true },
      import_react128.default.createElement(Transition$1, { in: _visible, mountOnEnter: true, nodeRef: tooltipRef, onEnter: onShow, onExit: onHide, timeout: {
        enter: 0,
...
var CWidgetStatsC = (0, import_react131.forwardRef)(function(_a, ref) {
  ...
  return import_react131.default.createElement(
    ...
    import_react131.default.createElement(
      CCardBody,
      null,
      icon && import_react131.default.createElement("div", { className: "text-end mb-4" }, icon),
